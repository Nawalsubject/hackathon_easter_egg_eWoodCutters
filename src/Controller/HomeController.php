...
class HomeController extends AbstractController
{
    ...
    private $class = [
        ['id' => 1, 'name' => 'Les Caïds', 'picture' => '/assets/images/caid.jpeg',
            'description' => 'Mi-ours, mi-scorpion et re-mi-ours derrière', 'bonus' => 'Force : + 2', 'Malus' => 'Intelligence : -20'],
        ...
        ['id' => 3, 'name' => 'Les Sportifs', 'picture' => '/assets/images/sportif.jpg',
            'description' => 'Foooooot , du foot, du foot , du foot !', 'bonus' => 'déplacement : + 1', 'Malus' => 'Micro pénis'],
        ['id' => 4, 'name' => 'Les Végans', 'picture' => '/assets/images/vegan.jpg',
            'description' => 'Je suis pas gros. je suis jovial et épanoui !', 'bonus' => 'Santé : + 20', 'Malus' => 'Charisme : -50']
    ];
    ...
    public function choice($kind, $player = 1)
    {
        ...
        if ($player == 1) {
            ...
            return $this->twig->render('Home/config.html.twig', ['classes' => $this->class, 'secondChoice' => true, 'player1' => $player1]);
        } else {
